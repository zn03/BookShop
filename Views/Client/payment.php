            ...
            <div class="infocustomer col-lg-7">
                <div class="container">
                        <form method="post" enctype="multipart/form-data" action="">
                            ...
                            <div class="text-dark">
                                <label for="quantity" class="form-label">Địa chỉ</label>
                    ...
                    <form method="post" action="?redirect=<?= $redirect ?>&action=update">
                        ...
                        ?>
                            <div class="cart-item row">
                                ...
                                <div class="cart-quantity col-lg-1 col-md-2 col-sm-12">
                                ...
                                <div class="cart-price col-lg-1 col-md-3 col-sm-12"><h5><?= number_format($item['product_price']); ?>đ</h5></div>
                                <div class="cart-price col-lg-1 col-md-3 col-sm-12"><h4><p><?= number_format($total_price); ?>đ</ơ></h4>
